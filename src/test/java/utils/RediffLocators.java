...
public class RediffLocators {
    ...
    public static final String RADIO_LOGIN = "#radio_login";
    public static final String PASSWORD_INPUT = "#newpasswd";
    public static final String DOB_DROPDOWNS = "select";
    public static final String COUNTRY_DROPDOWN = "#country";
    public static final String ALT_EMAIL_CHECKBOX = "input[name^='chk_altemail']";
}